...
class PopulationManager:
    ...
    async def get_population(self, code_dept: str) -> int | None:
...
TerritorialFactorsCalculator = TerritorialFactorsCalculatorV2
TerritorialFactorsRepository = TerritorialFactorsRepositoryV2
