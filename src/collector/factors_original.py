...
class PopulationManager:
    ...
    async def get_population(self, code_dept: str) -> Optional[PopulationData]:
    ...
    async def _store_population(self, pop_data: PopulationData):
        ...
        # Store in CSV
        csv_path = f"data/population_insee.csv"
        try:
...
class TerritorialFactorsCalculator:
    ...
    async def _get_latest_metrics(self, code_dept: Optional[str] = None) -> Dict[str, Dict]:
    ...
    async def _calculate_dept_factors(self, metrics: Dict, pop_data: PopulationData) -> Optional[TerritorialFactors]:
...
class TerritorialFactorsRepository:
    ...
    async def get_latest_factors(self, code_dept: Optional[str] = None) -> List[TerritorialFactors]:
