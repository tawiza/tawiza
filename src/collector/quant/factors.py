...
class AlphaFactorsCalculator:
    ...
    async def compute_all_factors(self) -> dict[str, dict[str, float | None]]:
    ...
    def _calculate_sante_entreprises(self, dept_data: dict[str, Any]) -> float | None:
    ...
    def _calculate_dynamisme_immo(self, dept_data: dict[str, Any]) -> float | None:
    ...
    def _calculate_declin_ratio(self, dept_data: dict[str, Any]) -> float | None:
...
async def compute_normalized_factors(database_url: str) -> dict[str, dict[str, float | None]]:
