...
EXPRESSION_CATEGORIES: Dict[str, List[str]] = {
    "business_health": [
        "sante_entreprises", "pression_fermeture", "dynamisme_creation", 
        "stabilite_entreprises", "commerce_sante", "momentum_commerce"
    ],
    "employment": [
        "tension_emploi", "tension_emploi_ma3", "momentum_emploi",
        "croissance_emploi", "stabilite_emploi"
    ],
    "real_estate": [
        "dynamisme_immo", "acceleration_prix", "pression_prix",
        "momentum_immo", "bulle_immo_signal", "stress_immobilier"
    ],
    "construction": [
        "acceleration_construction", "dynamisme_construction",
        "cycle_construction", "boom_construction"
    ],
    "convergence": [
        "convergence_positive", "convergence_negative", "signal_mixte"
    ],
    "momentum": [
        "tendance_6m", "acceleration_economie", "retournement_cycle"
    ],
    "risk": [
        "instabilite_economique", "risque_territorial", "indice_risque"
    ],
    "ranking": [
        "rang_creation", "rang_liquidation", "rang_emploi",
        "rang_immobilier", "score_competitivite"
    ],
    "seasonal": [
        "croissance_desaisonnalisee", "effet_saisonnier"
    ],
    "composite": [
        "indice_vitalite", "potentiel_croissance"
    ]
}
...
def get_expressions_by_category(category: str) -> List[Tuple[str, str]]:
    ...
    if category not in EXPRESSION_CATEGORIES:
        raise ValueError(f"Unknown category: {category}. Available: {list(EXPRESSION_CATEGORIES.keys())}")
...
DEFAULT_EXPRESSION_SETS: Dict[str, List[str]] = {
    ...
    "comprehensive": [
        "sante_entreprises", "tension_emploi_ma3", "dynamisme_immo",
        "acceleration_construction", "convergence_positive", "indice_vitalite",
        "momentum_emploi", "risque_territorial", "score_competitivite"
    ],
    "risk_focused": [
        "sante_entreprises", "pression_fermeture", "instabilite_economique",
        "risque_territorial", "indice_risque", "stress_immobilier"
    ],
    "momentum_focused": [
        "dynamisme_creation", "momentum_emploi", "dynamisme_immo",
        "cycle_construction", "tendance_6m", "acceleration_economie"
    ],
    "ranking_focused": [
        "rang_creation", "rang_liquidation", "rang_emploi",
        "rang_immobilier", "score_competitivite", "pression_prix"
    ]
}
...
def get_expression_set(set_name: str) -> List[Tuple[str, str]]:
    ...
    if set_name not in DEFAULT_EXPRESSION_SETS:
        raise ValueError(f"Unknown expression set: {set_name}. Available: {list(DEFAULT_EXPRESSION_SETS.keys())}")
...
def create_custom_expression(name: str, formula: str, 
                           description: str = "", 
