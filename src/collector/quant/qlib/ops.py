...
def _ensure_series(data: Series | DataFrame) -> Series:
...
def Ref(data: Series | DataFrame, n: int) -> Series:
    """
...
def Mean(data: Series | DataFrame, window: int) -> Series:
    """
...
def Std(data: Series | DataFrame, window: int) -> Series:
    """
...
def Max(data: Series | DataFrame, window: int) -> Series:
    """
...
def Min(data: Series | DataFrame, window: int) -> Series:
    """
...
def Delta(data: Series | DataFrame, n: int) -> Series:
    """
...
def ROC(data: Series | DataFrame, n: int) -> Series:
    """
...
def CSZScore(data: Series | DataFrame) -> Series:
    """
...
def CSRank(data: Series | DataFrame) -> Series:
    """
...
def Slope(data: Series | DataFrame, window: int) -> Series:
    """
...
def Momentum(data: Series | DataFrame, short: int = 3, long: int = 12) -> Series:
    """
...
def Volatility(data: Series | DataFrame, window: int = 6) -> Series:
    """
