...
class TerritorialScorer:
    ...
    def __init__(self, factors_data: Dict[str, Dict[str, Optional[float]]]):
    ...
    def compute_z_scores(self) -> Dict[str, Dict[str, Optional[float]]]:
        ...
        for factor_name in self.factor_names:
            ...
            if len(values) < 2:
                ...
                for dept in self.factors_data.keys():
