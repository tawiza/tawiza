...
class CausalLevel(BaseCognitiveLevel):
    ...
    async def _process_with_dag(
        ...
        avg_confidence = (
            ...
            if validated_links else DEFAULT_CONFIDENCE
        )
    ...
    def _extract_time_series(
        ...
        for r in results:
            ...
            for key in ['creations_12_mois', 'radiations_12_mois', 'creation_monthly',
                       'employment_monthly', 'growth_monthly']:
