...
class TheoreticalLevel(BaseCognitiveLevel):
    ...
    async def _process_with_analysis(self, previous: dict[str, Any]) -> dict[str, Any]:
    ...
    def _identify_relevant_theories(self, signals: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    def _validate_recommendations(
        self, recommendations: list[dict[str, Any]], theories_applied: list[dict[str, Any]]
    ) -> dict[str, list[dict[str, Any]]]:
        """Validate recommendations against applicable theories."""
        validation = {"strongly_supported": [], "supported": [], "neutral": [], "inconsistent": []}
    ...
    def _get_alignment_explanation(self, rec_type: str, theory_key: str, alignment: float) -> str:
        ...
        explanations = {
            ...
            (
                "diversification",
                "new_economic_geography",
            ): "Reduces concentration risk in agglomerations",
    ...
    def _generate_implementation_plans(
        ...
        for i, rec in enumerate(recommendations[:3]):
            ...
            # Get related actions
            related_actions = [a for a in actions if isinstance(a, dict)][
                :4
            ]  # Up to 4 actions per recommendation
    ...
    def _create_plan_for_type(
        ...
        duration_map = {"critical": 6, "high": 9, "medium": 12, "low": 18}
        ...
        if rec_type == "investment":
            ...
            stakeholders.extend(
                [
                    {
                        "role": "Finance Lead",
                        "responsibility": "Financial modeling and due diligence",
                    },
                    {
                        "role": "Business Development",
                        "responsibility": "Partner/target identification",
                    },
                ]
            )
            milestones = [
                ...
                Milestone(
                    ...
                    3,
                    "Identify acquisition/partnership targets",
                ...
                Milestone(
                    "Due Diligence",
                    5,
                    "Complete due diligence on selected target",
                ...
                Milestone(
                    "Deal Execution",
                    duration,
                    "Close transaction and integrate",
            ...
            resources = {
                "budget_range": "High",
                "team_size": 8,
                "tools": ["CRM", "Financial modeling"],
            }
            success_metrics = [
                {
                    "metric": "ROI",
                    "target": ">15% within 3 years",
                    "measurement": "Financial returns",
                },
                {
                    "metric": "Market Share",
                    "target": "+5% in target segment",
            ...
            milestones = [
                Milestone(
                    "Opportunity Mapping",
                    2,
                    "Map adjacent sectors",
                    ["Sector analysis", "Entry barriers assessment"],
                ),
                Milestone(
                    "Pilot Selection",
                    4,
                    "Select pilot diversification opportunity",
                ...
                Milestone(
                    "Scale Decision",
                    duration,
                    "Decide on scaling based on pilot",
            ...
            success_metrics = [
                {
                    ...
                    "target": "Reduce by 20%",
                    "measurement": "HHI index",
                },
                {
                    "metric": "Risk-Adjusted Returns",
                    "target": "Improve Sharpe ratio",
            ...
            milestones = [
                ...
                Milestone(
                    ...
                    duration,
                    "Fully embedded monitoring process",
            ...
            resources = {
                "budget_range": "Low",
                "team_size": 3,
                "tools": ["BI platform", "Data warehouse"],
            }
            success_metrics = [
                {
                    "metric": "Decision Latency",
                    "target": "<1 week from signal to action",
                    "measurement": "Process tracking",
                },
                {
                    "metric": "Forecast Accuracy",
                    "target": ">80%",
                    "measurement": "Prediction vs actual",
                },
            ]
            ...
            resources = {
                ...
                "team_size": 4,
                "tools": ["Risk management system"],
            }
            success_metrics = [
                {
                    "metric": "Maximum Drawdown",
                    "target": "<15%",
                    "measurement": "Portfolio performance",
                },
                {
            ...
            milestones = [
                Milestone(
                    "Exit Assessment",
                    1,
                    "Evaluate exit options and timing",
                    ["Options analysis", "Valuation range"],
                ),
                Milestone(
                    "Exit Plan Approved",
                    2,
                    "Board approval of exit strategy",
            ...
            success_metrics = [
                {
                    ...
                    "target": ">80% of book value",
                    "measurement": "Transaction value",
                },
                {
                    "metric": "Timeline",
    ...
    def _generate_plan_risks(
        self, rec_type: str, causes: list[dict[str, Any]], scenario: dict[str, Any]
    ) -> list[dict[str, str]]:
    ...
    def _compute_theory_confidence(
        self, validation: dict[str, list], theories_applied: list[dict[str, Any]]
    ) -> float:
    ...
    def _generate_executive_summary(
        ...
        return {
            ...
            "key_stakeholders": list({s["role"] for p in plans for s in p.stakeholders})[:5],
        }
    ...
    def _check_theory_relevance_simple(
        self, signals: list[dict[str, Any]], theory: dict[str, Any]
    ) -> float:
        """Simple theory relevance check."""
        indicators = theory.get("indicators", [])
        matches = sum(1 for s in signals if isinstance(s, dict) and s.get("type", "") in indicators)
