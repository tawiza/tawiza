...
NAF_SECTOR_MAP = {
    # Tech / IT
    "62.01Z": "tech",
    "6201Z": "tech",  # Computer programming
    "62.02A": "tech",
    "6202A": "tech",  # IT consulting
    "62.02B": "tech",
    "6202B": "tech",  # IT facilities management
    "62.03Z": "tech",
    "6203Z": "tech",  # Computer facilities management
    "62.09Z": "tech",
    "6209Z": "tech",  # Other IT activities
    "63.11Z": "tech",
    "6311Z": "tech",  # Data processing, hosting
    "63.12Z": "tech",
    "6312Z": "tech",  # Web portals
    "58.21Z": "tech",
    "5821Z": "tech",  # Publishing of computer games
    "58.29A": "tech",
    "5829A": "tech",  # Publishing of system software
    "58.29B": "tech",
    "5829B": "tech",  # Publishing of tools software
    "58.29C": "tech",
    "5829C": "tech",  # Publishing of application software
    # Biotech / Pharma
    "72.11Z": "biotech",
    "7211Z": "biotech",  # R&D biotechnology
    "72.19Z": "biotech",
    "7219Z": "biotech",  # Other R&D natural sciences
    "21.20Z": "biotech",
    "2120Z": "biotech",  # Pharmaceutical manufacturing
    "21.10Z": "biotech",
    "2110Z": "biotech",  # Manufacture of basic pharmaceutical
    # Commerce
    "47.11A": "commerce",
    "4711A": "commerce",  # Supermarkets
    "47.11B": "commerce",
    "4711B": "commerce",  # Convenience stores
    "47.11C": "commerce",
    "4711C": "commerce",  # Small groceries
    "47.11D": "commerce",
    "4711D": "commerce",  # Large supermarkets
    "47.11E": "commerce",
    "4711E": "commerce",  # Department stores
    "47.19A": "commerce",
    "4719A": "commerce",  # Large non-specialized stores
    "47.19B": "commerce",
    "4719B": "commerce",  # Other non-specialized retail
    # Industry
    "25.11Z": "industrie",
    "2511Z": "industrie",  # Manufacture of metal structures
    "25.62A": "industrie",
    "2562A": "industrie",  # Mechanical engineering
    "25.62B": "industrie",
    "2562B": "industrie",  # Industrial turning
    "28.99A": "industrie",
    "2899A": "industrie",  # Manufacture of other machines
    "28.99B": "industrie",
    "2899B": "industrie",  # Other machine manufacturing
    # Services
    "69.10Z": "services",
    "6910Z": "services",  # Legal activities
    "69.20Z": "services",
    "6920Z": "services",  # Accounting and auditing
    "70.10Z": "services",
    "7010Z": "services",  # Activities of head offices
    "70.22Z": "services",
    "7022Z": "services",  # Business consulting
    "73.11Z": "services",
    "7311Z": "services",  # Advertising agencies
}
...
class DataCollectTool(BaseTool):
    ...
    async def execute(
        self, territory: str, sector: str | None = None, limit: int = 100, use_real_api: bool = True
    ) -> dict[str, Any]:
        """
    ...
    async def _collect_from_api(
        self, territory: str, sector: str | None, limit: int
    ) -> dict[str, Any]:
    ...
    def _simulate_collection(self, territory: str, sector: str | None) -> dict[str, Any]:
...
class VeilleScanTool(BaseTool):
    ...
    async def execute(
        self, keywords: list[str], territory: str | None = None, days_back: int = 7
    ) -> dict[str, Any]:
        """
...
class SireneQueryTool(BaseTool):
    ...
    async def _query_api(
        self, siren: str | None, siret: str | None, commune: str | None, naf: str | None
    ) -> dict[str, Any]:
...
class TerritorialAnalysisTool(BaseTool):
    ...
    async def _analyze_from_api(
        self, territory: str, sectors: list[str], depth: str
    ) -> dict[str, Any]:
        ...
        results = await self._sirene_adapter.search(
            {"departement": territory, "limit": 500 if depth == "comprehensive" else 100}
        )
    ...
    def _simulate_analysis(self, territory: str, sectors: list[str], depth: str) -> dict[str, Any]:
        """Simulated analysis."""
        return {
            "territory": territory,
            "analysis_depth": depth,
    ...
    def _generate_findings(self, sector_analysis: dict[str, Any], territory: str) -> list[str]:
        ...
        if sector_analysis:
            ...
            findings.append(
                f"Strong {dominant[0]} sector with {dominant[1]['companies']} companies"
            )
